...
import { getPerson, latestVisibleCycle, recentCycles } from "@/lib/queries";
 ...
 * plus the things currently waiting on this person right now. The second half
 * matters because GUIDE's notification rules require a reminder to say what it
 * is about — "please submit your report" is called out as the bad example —
 * and the only way to do that is to read the same live state the reminder
